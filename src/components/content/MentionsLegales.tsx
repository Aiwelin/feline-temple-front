  ...
  return (
    <div id="mentions-legales" className="mentions-legales">
      ...
      <p>
        ...
        vulputate porttitor tortor eu lobortis. Donec in aliquet dui, ut posuere
        mi. Nulla imperdiet, enim quis tristique ullamcorper, velit dui
        ultricies sem, et elementum elit justo non augue. Etiam pharetra
        facilisis nisl a malesuada. Cras sapien erat, efficitur vitae maximus
        ac, elementum in ex. Sed vitae tempus purus, sit amet interdum felis.
        Vestibulum dignissim ultrices diam, ut porttitor ligula eleifend ac.
        Orci varius natoque penatibus et magnis dis parturient montes, nascetur
        ridiculus mus. Nullam vel pellentesque dolor. Ut blandit ac velit ut
      ...
      <p>
        ...
        ullamcorper, eros quis facilisis lobortis, lacus nisl molestie nibh, non
        congue neque nisl eget massa. Donec nec malesuada lectus. Phasellus
        vehicula, quam nec volutpat ornare, dui tortor commodo erat, in faucibus
        elit dui quis risus. Donec congue consectetur massa, et congue nunc
        sagittis vitae. Ut nunc est, aliquet quis venenatis eu, hendrerit vitae
        arcu. Quisque ornare id est ut ultricies. Nunc nec metus eget mauris
        rutrum eleifend. Suspendisse nisi neque, tempus eu nulla a, ultrices
        pretium purus. Maecenas purus tortor, viverra nec nisl varius, facilisis
        luctus ligula. Vivamus a diam feugiat, varius nulla euismod, aliquet
        nisl. In tempus in orci ut finibus. Cras vitae lorem eu nisi hendrerit
      ...
      <p>
        ...
        interdum. Integer id turpis a nisl pretium sodales. Duis diam nisl,
        consequat id fermentum id, malesuada sed dolor. Nulla ut laoreet massa.
        Proin vitae tellus dolor. Etiam congue quis tellus ut mollis. Vestibulum
      ...
      <p>
        ...
        arcu, nec condimentum libero suscipit non. Donec tempor pretium auctor.
        Praesent lobortis, tortor non mollis dapibus, massa augue gravida dolor,
        non blandit lectus massa ac ex. Nullam egestas fermentum justo, eu
        pellentesque ante blandit vel. Sed massa arcu, pellentesque pharetra
        purus vitae, facilisis faucibus tortor. Aenean eu sodales sapien, non
        scelerisque nisi. Curabitur quam lorem, finibus ac lorem ut, cursus
        accumsan nulla.
      </p>
    </div>
  );
